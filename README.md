<!-- shieldcn-start -->
![GitHub Stars](https://www.shieldcn.dev/github/stars/uptimekit/uptimekit.svg?variant=secondary) ![GitHub Forks](https://www.shieldcn.dev/github/forks/uptimekit/uptimekit.svg?variant=secondary) ![Watchers](https://www.shieldcn.dev/github/watchers/uptimekit/uptimekit.svg?variant=secondary) ![Contributors](https://www.shieldcn.dev/github/contributors/uptimekit/uptimekit.svg?theme=emerald) ![Last commit](https://www.shieldcn.dev/github/last-commit/uptimekit/uptimekit.svg?variant=secondary) ![Open issues](https://www.shieldcn.dev/github/open-issues/uptimekit/uptimekit.svg?variant=secondary) ![Open PRs](https://www.shieldcn.dev/github/open-prs/uptimekit/uptimekit.svg?variant=secondary) ![Release](https://www.shieldcn.dev/github/release/uptimekit/uptimekit.svg) ![CI](https://www.shieldcn.dev/github/ci/uptimekit/uptimekit.svg?variant=secondary) ![License](https://www.shieldcn.dev/github/license/uptimekit/uptimekit.svg?variant=ghost) ![Private package](https://www.shieldcn.dev/badge/Private-package-red.svg?variant=secondary) ![Package mgr · Bun](https://www.shieldcn.dev/badge/Package_mgr-Bun-000000.svg?logo=bun&variant=branded) ![Container · Docker](https://www.shieldcn.dev/badge/Container-Docker-2496ED.svg?logo=docker&variant=branded) ![Lint · Biome](https://www.shieldcn.dev/badge/Lint-Biome-60A5FA.svg?logo=biome&variant=branded) ![Monorepo · Turborepo](https://www.shieldcn.dev/badge/Monorepo-Turborepo-EF4444.svg?logo=turborepo&variant=branded) ![Drizzle](https://www.shieldcn.dev/badge/Stack-Drizzle-C5F74F.svg?logo=drizzle&variant=branded) ![PostgreSQL](https://www.shieldcn.dev/badge/Stack-PostgreSQL-4169E1.svg?logo=postgresql&variant=branded) ![Zod](https://www.shieldcn.dev/badge/Stack-Zod-3E67B1.svg?logo=zod&variant=branded) ![Husky](https://www.shieldcn.dev/badge/Stack-Husky-3B82F6.svg?logo=husky&variant=branded) ![lint-staged](https://www.shieldcn.dev/badge/Stack-lint--staged-F05032.svg?logo=git&variant=branded) ![TypeScript](https://www.shieldcn.dev/badge/Stack-TypeScript-3178C6.svg?logo=typescript&variant=branded) ![ESM only](https://www.shieldcn.dev/badge/ESM-only-16a34a.svg?variant=secondary) ![Monorepo yes](https://www.shieldcn.dev/badge/Monorepo-yes-2563eb.svg?variant=secondary) ![Agent-friendly AGENTS.md](https://www.shieldcn.dev/badge/Agent--friendly-AGENTS.md-D97757.svg?variant=secondary) ![GitHub Sponsors](https://www.shieldcn.dev/badge/Sponsor-GitHub-ea4aaa.svg?logo=githubsponsors&variant=secondary)
<!-- shieldcn-end -->
